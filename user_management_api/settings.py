...
SECRET_KEY = 'django-insecure-t%786=^53#6t9u0r)-(k#nn$#429n1n2y)u8$x=c5f_k!@pv_f'
...
#         'rest_framework_simplejwt.authentication.JWTAuthentication',
#         'management.serializers.CustomJWTAuthentication',
#     )
...
MEDIA_ROOT = BASE_DIR = Path(BASE_DIR / 'media')
MEDIA_URL = '/media/'
...
USE_I18N = True  # Enables internationalization (translations)
USE_L10N = True  # Enables localization (date and number formatting)
